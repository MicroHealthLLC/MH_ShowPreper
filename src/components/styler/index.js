...
export default class extends React.Component {
  componentDidMount() {
    ...
    $('#sp-styler-modal').on('shown.bs.modal', e => {
      $('#sp-styler-tab-border').trigger('click')
      $('#sp-styler-tab-background').trigger('click')
    })
  }
                ...
                <div className="col-xs-12">
                  <ul className="nav nav-tabs" role="tablist">
                    ...
                    <li>
                      <a
                        data-toggle="tab"
                        href="#spStylerTabBorder"
                        id="sp-styler-tab-border"
                      >
                        {lang.border}
                      </a>
                    </li>
                  ...
                  <div className="tab-content">
                    <div id="spStylerTabBackground" className="tab-pane fade">
                      <ColorPatternEditor
